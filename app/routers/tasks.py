...
@router.get(
    ...
    description="Retrieve a list of tasks with optional filtering based on title and completion status. You can provide query parameters to filter the results.",
)
